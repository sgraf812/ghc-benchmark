...
nofib-analyse --columns=Allocs,Instrs -l -i 0.1  $pruned | ./fixup.pl -0.3 0.0 1 > usage-anal-nofib-table.tex
nofib-analyse --columns=Allocs -l -i 0.1  $pruned | ./fixup.pl 0.0 0.0 1 > usage-anal-nofib-table-alloc.tex
nofib-analyse --columns=Instrs -l -i 0.1  $pruned | ./fixup.pl -3.0 1.0 0 > usage-anal-nofib-table-instrs.tex
